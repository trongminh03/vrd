...
class VG_Detection(torchvision.datasets.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        img, target = super(VG_Detection, self).__getitem__(idx)
...
class VG_Dataset(VG_Detection):
    def __init__(
        self, data_folder, feature_extractor, split, num_object_queries=100, debug=False
    ):
        super(VG_Dataset, self).__init__(data_folder, feature_extractor, split, debug)
