...
from src.evaluation.coco_eval import CocoEvaluator
...
from src.models.util import collate_fn, evaluate_batch
import torch
...
if __name__ == "__main__":
    ...
    for k in list(state_dict.keys()):
        # state_dict[k[6:]] = state_dict.pop(k)  # "model." for "model" prefix ckpt
        state_dict[k[4:]] = state_dict.pop(k)  # "net." for "net" prefix ckpt
